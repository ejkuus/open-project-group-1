...
void Goal_Request__rosidl_typesupport_introspection_c__Goal_Request_init_function(
...
void Goal_Request__rosidl_typesupport_introspection_c__Goal_Request_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers Goal_Request__rosidl_typesupport_introspection_c__Goal_Request_message_members = {
  ...
  Goal_Request__rosidl_typesupport_introspection_c__Goal_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  Goal_Request__rosidl_typesupport_introspection_c__Goal_Request_fini_function  // function to terminate message instance (will not free memory)
};
...
void Goal_Response__rosidl_typesupport_introspection_c__Goal_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void Goal_Response__rosidl_typesupport_introspection_c__Goal_Response_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers Goal_Response__rosidl_typesupport_introspection_c__Goal_Response_message_members = {
  ...
  Goal_Response__rosidl_typesupport_introspection_c__Goal_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  Goal_Response__rosidl_typesupport_introspection_c__Goal_Response_fini_function  // function to terminate message instance (will not free memory)
};
